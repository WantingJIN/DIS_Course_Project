...
void reynolds_rules()
{
	...
	for (i = 0; i < FLOCK_SIZE; i++)
	{
		...
		for (j = 0; j < 2; j++)
		{
			...
			printf("Robot id %d, speed of robot %d, %d = %f\n", robot_id, i, j, relative_speed[i][j] + speed[robot_id][j]);
	...
	for (j = 0; j < 2; j++)
	{
		...
		//printf("Robot id %d, speed[%d] =  %f\n", robot_id, j, speed[robot_id][j]);
	}
...
void process_received_ping_messages(void)
{
	...
	while (wb_receiver_get_queue_length(receiver2) > 0)
	{
		...
		//printf("Robot %d, from robot %d, x: %g, y: %g, theta %g, my theta %g\n",robot_id, other_robot_id,my_position[0],my_position[1],-atan2(y,x)*180.0/3.141592,my_position[2]*180.0/3.141592);
		...
		//printf("For robot %d, other robot %d, difference between relative_pos 0 : %f\n", robot_id, other_robot_id, relative_pos[other_robot_id][0] - prev_relative_pos[other_robot_id][0]);
		//printf("For robot %d, other robot %d, difference between relative_pos 1 : %f\n", robot_id, other_robot_id, relative_pos[other_robot_id][1] - prev_relative_pos[other_robot_id][1]);
...
int main()
{
	...
	for (;;)
	{
		...
		printf("For robot %d, my_position 0 = %f, my_position 1 = %f\n", robot_id, my_position[0], my_position[1]);
